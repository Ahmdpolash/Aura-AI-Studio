              ...
              >
                ...
                <span
                  className={cn(
                    ...
                    isActive ? "text-white font-bold" : "text-muted-foreground/80 group-hover:text-foreground"
                  )}
                >
                  ...
                  <span
                    className={cn(
                      ...
                      isActive ? "bg-black/30 text-white" : "bg-white/10 text-muted-foreground group-hover:text-foreground"
                    )}
                  >
                    {cat.count}
                  </span>
        ...
        {selectedTool.requiresTextWatermark && (
          ...
          >
            <div className="rounded-2xl border border-white/15 bg-white/[0.035] p-3.5 sm:p-4 backdrop-blur-xl shadow-[inset_0_1px_0_0_rgba(255,255,255,0.08),0_4px_24px_rgba(0,0,0,0.25)] transition-all space-y-2.5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                <div className="rounded-xl border border-white/10 bg-black/25 p-2">
                  <div className="flex items-center justify-between text-[11px] mb-1">
                    ...
                    <span className="tabular-nums font-bold text-primary">{watermarkFontSize}px</span>
                  </div>
                  <input
                    type="range"
                    min="16"
                ...
                <div className="rounded-xl border border-white/10 bg-black/25 p-2">
                  <span className="text-[11px] font-medium text-muted-foreground block mb-1">Color</span>
                  <div className="flex items-center gap-1.5">
              ...
              <div>
                <span className="text-[11px] font-medium text-muted-foreground block mb-1">Position</span>
              ...
              <div className="flex items-center justify-between rounded-xl border border-white/10 bg-black/20 px-2.5 py-1.5">
                <div>
                  <p className="text-xs font-semibold text-foreground">Glass Badge Backdrop</p>
                  <p className="text-[10px] text-muted-foreground">Dark pill behind text</p>
                </div>
                <button
                  type="button"
                  ...
                  className={cn(
                    ...
                    watermarkBadge ? "bg-primary shadow-[0_0_10px_rgba(255,90,20,0.4)]" : "bg-white/10"
                  )}
                >
                  <span
                    className={cn(
